...
def get_investigation_parameter(icat_client: ICATClient, investigation_name: str, parameter_name: str,
                                create_if_missing: bool = True) -> Entity | None:
    return get_entity_parameter(icat_client, "Investigation", parameter_name,
                                conditions={"name__eq": investigation_name}, create_if_missing=create_if_missing)
