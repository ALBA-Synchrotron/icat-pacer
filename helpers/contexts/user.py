...
def create_user_context(user_data: str | dict, username_prefix: str = "") -> UserContext:
    ...
    user_ctx = UserContext(
        ...
        is_staff=user_dict.get("is_staff", None),
        enabled=user_dict.get("enabled", None),
        uos_id=user_dict.get("id", None),
