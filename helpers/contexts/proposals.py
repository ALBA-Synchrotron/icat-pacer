...
def create_investigation_context(investigation_data: str | dict,
    ...
    icat_visit_id: str = investigation_dict.get("icat_visit_id", instrument.get("name", "").lower())
    visa_visit_id: int = investigation_dict.get("visa_visit_id", int(investigation_name.replace("-", "")))
